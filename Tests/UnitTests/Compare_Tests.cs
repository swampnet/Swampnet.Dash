					...
					new Rule()
					{
						...
						Actions = new System.Collections.Generic.List<ActionDefinition>()
						{
							new ActionDefinition()
							{
								...
								Parameters = new System.Collections.Generic.List<ActionDefinitionParameter>(){
									new ActionDefinitionParameter("parameter-01", "value-01"),
									new ActionDefinitionParameter("parameter-02", "value-02")
								},
								ConsecutiveHits = 1
							},
							new ActionDefinition()
							{
								ActionName = "another-action-name"
							}
						}
					}
				}
